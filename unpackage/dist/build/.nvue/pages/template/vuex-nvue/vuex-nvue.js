...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { class: "uni-product" }, [
      ...
      createElementVNode("u-text", { class: "username" }, "用户名：" + toDisplayString($options.username), 1),
      createElementVNode("u-text", { class: "sex" }, "性别：" + toDisplayString($options.sex), 1),
      createElementVNode("view", { class: "age" }, [
        createElementVNode("u-text", null, "年龄：" + toDisplayString($options.age), 1)
      ]),
      createElementVNode("view", { class: "doubleAge" }, [
        createElementVNode("u-text", null, "年龄翻倍：" + toDisplayString($options.doubleAge), 1)
      ]),
...
const vuexNvue = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  vuexNvue as default
};
