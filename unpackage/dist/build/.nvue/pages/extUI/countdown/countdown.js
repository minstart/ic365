...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("view", {
    ...
    $props.showHour ? (openBlock(), createElementBlock("u-text", {
      key: 2,
      style: normalizeStyle([$options.timeStyle]),
      class: "uni-countdown__number"
    }, toDisplayString($data.h), 5)) : createCommentVNode("", true),
    $props.showHour ? (openBlock(), createElementBlock("u-text", {
      key: 3,
      style: normalizeStyle([$options.splitorStyle]),
      class: "uni-countdown__splitor"
    }, toDisplayString($props.showColon ? ":" : $options.hourText), 5)) : createCommentVNode("", true),
    $props.showMinute ? (openBlock(), createElementBlock("u-text", {
      key: 4,
      style: normalizeStyle([$options.timeStyle]),
      class: "uni-countdown__number"
    }, toDisplayString($data.i), 5)) : createCommentVNode("", true),
    $props.showMinute ? (openBlock(), createElementBlock("u-text", {
      key: 5,
      style: normalizeStyle([$options.splitorStyle]),
      class: "uni-countdown__splitor"
    }, toDisplayString($props.showColon ? ":" : $options.minuteText), 5)) : createCommentVNode("", true),
