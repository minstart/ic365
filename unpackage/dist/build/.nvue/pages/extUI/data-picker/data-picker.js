  ...
  return openBlock(), createElementBlock("view", {
      ...
      createElementVNode("view", { class: "selected-list" }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.selected, (item, index) => {
          return openBlock(), createElementBlock("view", {
            ...
            createElementVNode("u-text", null, toDisplayString(item.text || ""), 1)
          ], 10, ["onClick"]);
        }), 128))
      ])
    ...
    createElementVNode("view", { class: "tab-c" }, [
      createElementVNode("scroll-view", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.dataList[_ctx.selectedIndex], (item, j) => {
          return openBlock(), createElementBlock("view", {
            class: normalizeClass(["item", { "is-disabled": !!item.disable }]),
            key: j,
            onClick: ($event) => $options.handleNodeClick(item, _ctx.selectedIndex, j)
          }, [
            createElementVNode("u-text", { class: "item-text" }, toDisplayString(item[_ctx.map.text]), 1),
              ...
              default: withCtx(({ data, error, options }) => [
                createElementVNode("view", { class: "input-border" }, [
                  error ? (openBlock(), createElementBlock("view", {
                    ...
                    createElementVNode("u-text", null, toDisplayString(error), 1)
