...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    $props.showRewardPopUp ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($props.rewardPopUpList, (item) => {
      return openBlock(), createElementBlock("view", { class: "reward-pop-up-wrap" }, [
        createElementVNode("view", {
          class: "pop-up-type",
          "data-type": item.type
        }, [
          createElementVNode("view", { class: "reward-pop-up-back" }),
          createElementVNode("div", { class: "reward-pop-up-content" })
        ], 8, ["data-type"])
      ]);
