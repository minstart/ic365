  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return $data.showPopup ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)(
      "view",
      {
        ...
        style: (0, import_vue2.normalizeStyle)($props.style),
        renderWhole: true
      },
      [
    ...
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)(
      ...
      [
              ...
              (0, import_vue2.createElementVNode)("view", { class: "become-member-window" }, [
                (0, import_vue2.createElementVNode)(
                  "view",
                  {
                    ...
                    style: (0, import_vue2.normalizeStyle)("transform: scale(" + $props.becomeMemberSize + ");")
                  },
                  [
          ...
          default: (0, import_vue2.withCtx)(() => [
            (0, import_vue2.createElementVNode)("view", { class: "popup-tips-wrap" }, [
              ...
              (0, import_vue2.createElementVNode)("view", { class: "popup-tips-btn-wrap" }, [
                (0, import_vue2.createElementVNode)("view", {
                  class: "tips-btn",
                  onClick: _cache[2] || (_cache[2] = (0, import_vue2.withModifiers)((...args) => $options.closePopupTips && $options.closePopupTips(...args), ["stop"]))
                }, [
                  (0, import_vue2.createElementVNode)("u-text", null, "\u53D6\u6D88")
                ]),
                (0, import_vue2.createElementVNode)("view", { class: "border" }),
                (0, import_vue2.createElementVNode)("view", {
                  class: "tips-btn",
                  onClick: _cache[3] || (_cache[3] = (0, import_vue2.withModifiers)((...args) => $data.tipsData.success && $data.tipsData.success(...args), ["stop"]))
                }, [
                  (0, import_vue2.createElementVNode)("u-text", null, "\u786E\u5B9A")
                ])
              ])
            ])
          ]),
        ...
        (0, import_vue2.createVNode)(_component_uni_popup, {
          ...
          default: (0, import_vue2.withCtx)(() => [
            (0, import_vue2.createElementVNode)("view", { class: "msg-tips-wrap" }, [
              (0, import_vue2.createElementVNode)("view", {
                class: "msg-tips-icon",
              ...
              $data.msgData.icon == "2" ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
                key: 0,
                class: "msg-tips-btn-wrap"
              }, [
                (0, import_vue2.createElementVNode)("view", {
                  class: "tips-btn",
                  onClick: _cache[4] || (_cache[4] = (0, import_vue2.withModifiers)((...args) => $options.closeMsgTips && $options.closeMsgTips(...args), ["stop"]))
                }, [
                  (0, import_vue2.createElementVNode)("u-text", null, "\u77E5\u9053\u4E86")
                ])
              ])) : (0, import_vue2.createCommentVNode)("v-if", true)
            ])
          ]),
