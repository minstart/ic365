...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_uni_calendar = resolveEasycom(resolveDynamicComponent("uni-calendar"), __easycom_2);
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    $data.showCalendar ? (openBlock(), createElementBlock("view", {
      ...
      createVNode(_component_uni_card, {
        ...
        default: withCtx(() => [
          createElementVNode("u-text", { class: "uni-h6" }, "日历组件可以查看日期，选择任意范围内的日期，打点操作。常用场景如：酒店日期预订、火车机票选择购买日期、上下班打卡等。")
        ]),
        _: 1
        /* STABLE */
      }),
