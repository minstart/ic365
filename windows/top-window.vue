<template>
	<view class="top-window-header">
		<view class="left-header logo">
			<navigator class="logo" open-type="reLaunch" url="/pages/page/index/index">
		...
		<!-- #ifdef VUE2 -->
		<uni-link class="phone-link" href="http://vue3-hellouniapp.dcloud.net.cn/pages/page/index/index" text="体验 vue 3.0 版"></uni-link>
